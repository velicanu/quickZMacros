   ...
   Float_t         b;
   Int_t           nref;
   Float_t         rawpt[3000];   //[nref]
   Float_t         jtpt[3000];   //[nref]
   Float_t         jteta[3000];   //[nref]
   Float_t         jty[3000];   //[nref]
   Float_t         jtphi[3000];   //[nref]
   Float_t         jtpu[3000];   //[nref]
   Float_t         jtm[3000];   //[nref]
   Float_t         discr_fr01[3000];   //[nref]
   Float_t         trackMax[3000];   //[nref]
   Float_t         trackSum[3000];   //[nref]
   Int_t           trackN[3000];   //[nref]
   Float_t         trackHardSum[3000];   //[nref]
   Int_t           trackHardN[3000];   //[nref]
   Float_t         chargedMax[3000];   //[nref]
   Float_t         chargedSum[3000];   //[nref]
   Int_t           chargedN[3000];   //[nref]
   Float_t         chargedHardSum[3000];   //[nref]
   Int_t           chargedHardN[3000];   //[nref]
   Float_t         photonMax[3000];   //[nref]
   Float_t         photonSum[3000];   //[nref]
   Int_t           photonN[3000];   //[nref]
   Float_t         photonHardSum[3000];   //[nref]
   Int_t           photonHardN[3000];   //[nref]
   Float_t         neutralMax[3000];   //[nref]
   Float_t         neutralSum[3000];   //[nref]
   Int_t           neutralN[3000];   //[nref]
   Float_t         eMax[3000];   //[nref]
   Float_t         eSum[3000];   //[nref]
   Int_t           eN[3000];   //[nref]
   Float_t         muMax[3000];   //[nref]
   Float_t         muSum[3000];   //[nref]
   Int_t           muN[3000];   //[nref]
   Float_t         discr_ssvHighEff[3000];   //[nref]
   Float_t         discr_ssvHighPur[3000];   //[nref]
   Float_t         discr_csvMva[3000];   //[nref]
   Float_t         discr_csvSimple[3000];   //[nref]
   Float_t         discr_muByIp3[3000];   //[nref]
   Float_t         discr_muByPt[3000];   //[nref]
   Float_t         discr_prob[3000];   //[nref]
   Float_t         discr_probb[3000];   //[nref]
   Float_t         discr_tcHighEff[3000];   //[nref]
   Float_t         discr_tcHighPur[3000];   //[nref]
   Float_t         ndiscr_ssvHighEff[3000];   //[nref]
   Float_t         ndiscr_ssvHighPur[3000];   //[nref]
   Float_t         ndiscr_csvSimple[3000];   //[nref]
   Float_t         ndiscr_muByPt[3000];   //[nref]
   Float_t         ndiscr_prob[3000];   //[nref]
   Float_t         ndiscr_probb[3000];   //[nref]
   Float_t         ndiscr_tcHighEff[3000];   //[nref]
   Float_t         ndiscr_tcHighPur[3000];   //[nref]
   Float_t         pdiscr_csvSimple[3000];   //[nref]
   Float_t         pdiscr_prob[3000];   //[nref]
   Float_t         pdiscr_probb[3000];   //[nref]
   Int_t           nsvtx[3000];   //[nref]
   Int_t           svtxntrk[3000];   //[nref]
   Float_t         svtxdl[3000];   //[nref]
   Float_t         svtxdls[3000];   //[nref]
   Float_t         svtxdl2d[3000];   //[nref]
   Float_t         svtxdls2d[3000];   //[nref]
   Float_t         svtxm[3000];   //[nref]
   Float_t         svtxpt[3000];   //[nref]
   Int_t           nIPtrk[3000];   //[nref]
   Int_t           nselIPtrk[3000];   //[nref]
   /*Int_t           nIP;
   Int_t           ipJetIndex[300000];   //[nIP]
   Float_t         ipPt[300000];   //[nIP]
   Float_t         ipProb0[300000];   //[nIP]
   Float_t         ipProb1[300000];   //[nIP]
   Float_t         ip2d[300000];   //[nIP]
   Float_t         ip2dSig[300000];   //[nIP]
   Float_t         ip3d[300000];   //[nIP]
   Float_t         ip3dSig[300000];   //[nIP]
   Float_t         ipDist2Jet[300000];   //[nIP]
   Float_t         ipDist2JetSig[300000];   //[nIP]
   Float_t         ipClosest2Jet[300000];   //[nIP]*/
   Float_t         mue[3000];   //[nref]
   Float_t         mupt[3000];   //[nref]
   Float_t         mueta[3000];   //[nref]
   Float_t         muphi[3000];   //[nref]
   Float_t         mudr[3000];   //[nref]
   Float_t         muptrel[3000];   //[nref]
   Int_t           muchg[3000];   //[nref]
